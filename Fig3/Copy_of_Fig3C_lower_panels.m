...
% Error tolerance
options = odeset('RelTol',1e-13,'AbsTol',repmat(1e-8,[1,13]));
...
for i = 1:numel(V_list)
    ...
    title([]); xticks([0:200:600]); ylim([0,100])
    set(gca,'fontsize',40)
end
...
sT = 1000;  % total SPEN concentration
XbsT =  100; % concentration of Xist binding sites
