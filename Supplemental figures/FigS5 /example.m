...
% Initial conditions
act = 0; x1f = 0; x2f = 0; x3f = 0;
x1b = 20; x2b = 20; x3b = 20; s1b = 100; s2b = 20; s3b = 100;
...
legend('ChrX #1','ChrX #2','ChrX #3','Location','best'); %xlim([0,5000]); ylim([0,100])
